...
impl Clone for IntMat {
    ...
    fn clone(&self) -> Self {
        ...
        unsafe {
            fmpz_mat_init_set(z.as_mut_ptr(), self.as_ptr());
...
impl Drop for IntMat {
    #[inline]
    fn drop(&mut self) {
        unsafe { fmpz_mat_clear(self.as_mut_ptr()) }
    }
}
...
impl IntMat {
    ...
    #[inline]
    pub const fn into_raw(self) -> fmpz_mat_struct {
...
impl IntMat {
    pub fn new<T, const CAP: usize>(src: [T; CAP], nrows: i64, ncols: i64) -> Self
    where
        T: Into<Integer>
    {
...
impl IntMat {
    ...
    #[inline]
    pub(crate) fn check_indices(&self, i: usize, j: usize) -> (i64, i64) {
        (self.check_row_index(i), self.check_col_index(j))
    }

    #[inline]
    pub(crate) fn check_row_index(&self, i: usize) -> i64 {
    ...
    #[inline]
    pub(crate) fn check_col_index(&self, j: usize) -> i64 {
    ...
    */
    ...
    pub fn zero(nrows: i64, ncols: i64) -> IntMat {
        let mut z = MaybeUninit::uninit();
        unsafe {
            fmpz_mat_init(z.as_mut_ptr(), nrows, ncols);
            IntMat::from_raw(z.assume_init())
        }
    }
    ...
    pub fn nrows_si(&self) -> i64 {
        unsafe { fmpz_mat_nrows(self.as_ptr())}
    }
    ...
    pub fn ncols_si(&self) -> i64 {
        unsafe { fmpz_mat_ncols(self.as_ptr())}
    }

    #[inline]
    pub fn is_empty(&self) -> bool {
        unsafe { fmpz_mat_is_empty(self.as_ptr()) != 0 }
    }

    #[inline]
    pub fn is_square(&self) -> bool {
        unsafe { fmpz_mat_is_square(self.as_ptr()) != 0 }
    }

    #[inline]
    pub fn is_zero(&self) -> bool {
        unsafe { fmpz_mat_is_zero(self.as_ptr()) != 0 }
    }

    #[inline]
    pub fn is_one(&self) -> bool {
        unsafe { fmpz_mat_is_one(self.as_ptr()) != 0 }
    }
    ...
    pub fn assign_entry(&self, i: usize, j: usize, out: &mut Integer) {
        ...
        unsafe {
            let x = fmpz_mat_entry(self.as_ptr(), i, j);
            fmpz_set(out.as_mut_ptr(), x);
        }
    }
    ...
    pub fn swap(&mut self, other: &mut IntMat) {
        unsafe { 
            fmpz_mat_swap(self.as_mut_ptr(), other.as_mut_ptr()); 
        }
    }
    ...
    */
    ...
    pub fn is_zero_row(&self, i: usize) -> bool { 
        ...
        unsafe {
            fmpz_mat_is_zero_row(self.as_ptr(), i) != 0
        }
    }
    ...
    pub fn transpose(&self) -> IntMat {
        ...
        unsafe {
            fmpz_mat_transpose(res.as_mut_ptr(), self.as_ptr());
        }
        res
    }
    ...
    pub fn transpose_assign(&mut self) {
        assert!(self.is_square());
        unsafe { fmpz_mat_transpose(self.as_mut_ptr(), self.as_ptr()); }
    }
    ...
    pub fn submatrix(&self, r1: usize, c1: usize, r2: usize, c2: usize) -> IntMat {
        ...
        unsafe {
            ...
            fmpz_mat_set(res.as_mut_ptr(), win.as_ptr());
            fmpz_mat_window_clear(win.as_mut_ptr());
        }
        res
    ...
    pub fn square(&self) -> Self {
        ...
        let mut res = IntMat::zero(self.nrows_si(), self.ncols_si());
        unsafe {
            fmpz_mat_sqr(res.as_mut_ptr(), self.as_ptr()) 
        }
        res
    }
    ...
    pub fn square_assign(&mut self) {
        assert!(self.is_square());
        unsafe { 
            fmpz_mat_sqr(self.as_mut_ptr(), self.as_ptr());
        }
    }
    ...
    pub fn det_bound(&self) -> Integer {
        ...
        let mut res = Integer::zero();
        unsafe { 
            fmpz_mat_det_bound(res.as_mut_ptr(), self.as_ptr()); 
        }
        res
    }
    ...
    pub fn det_divisor(&self) -> Integer {
        ...
        let mut res = Integer::zero();
        unsafe { 
            fmpz_mat_det_divisor(res.as_mut_ptr(), self.as_ptr()); 
        }
        res
    }
    ...
    pub fn charpoly(&self) -> IntPoly {
        ...
        unsafe { 
            fmpz_mat_charpoly(res.as_mut_ptr(), self.as_ptr()); 
        }
        res
    }
    ...
    pub fn minpoly(&self) -> IntPoly {
        ...
        let mut res = IntPoly::zero();
        unsafe { 
            fmpz_mat_minpoly(res.as_mut_ptr(), self.as_ptr()); 
        }
        res
    }
    ...
    pub fn rank(&self) -> i64 {
        unsafe { fmpz_mat_rank(self.as_ptr()) }
    }
    ...
    */
        ...
        T: AsRef<Integer>
    {
        ...
        let mut res = IntMat::zero(self.nrows_si(), self.ncols_si());
        unsafe {
            let rank = fmpz_mat_howell_form_mod(
                res.as_mut_ptr(),
                modulus.as_ref().as_ptr()
            );
            (rank, res)
    ...
    pub fn hnf(&self) -> IntMat {
        let mut res = IntMat::zero(self.nrows_si(), self.ncols_si());
        unsafe { 
            fmpz_mat_hnf(res.as_mut_ptr(), self.as_ptr()); 
        }
        res
    }
    ...
    pub fn is_hnf(&self) -> bool {
        unsafe { fmpz_mat_is_in_hnf(self.as_ptr()) == 1 }
    }
    
    pub fn snf(&self) -> IntMat {
        let mut res = IntMat::zero(self.nrows_si(), self.ncols_si());
        unsafe { fmpz_mat_snf(res.as_mut_ptr(), self.as_ptr()); }
        res
    }
    
    pub fn is_snf(&self) -> bool {
        unsafe { fmpz_mat_is_in_snf(self.as_ptr()) == 1 }
    }
