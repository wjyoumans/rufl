...
impl Clone for RatPoly {
    ...
    fn clone(&self) -> Self {
        ...
        unsafe {
            fmpq_poly_set(res.as_mut_ptr(), self.as_ptr());
        }
        res
    }
}
...
impl Drop for RatPoly {
    #[inline]
    fn drop(&mut self) {
        unsafe { fmpq_poly_clear(self.as_mut_ptr()) }
    }
}
...
impl RatPoly {
    ...
    #[inline]
    pub const fn as_ptr(&self) -> *const fmpq_poly_struct {
        &self.inner
    }
    ...
    #[inline]
    pub const unsafe fn from_raw(inner: fmpq_poly_struct) -> Self {
        RatPoly { inner }
    }

    #[inline]
    pub const fn into_raw(self) -> fmpq_poly_struct {
...
impl RatPoly {
    #[inline]
    pub fn new<T: Into<RatPoly>>(src: T) -> Self {
        src.into()
    }
    ...
    pub fn one() -> Self {
        let mut res = RatPoly::default();
        unsafe { fmpq_poly_one(res.as_mut_ptr()); }
        res
    }

    #[inline]
    pub fn zero_assign(&mut self) {
        unsafe { fmpq_poly_zero(self.as_mut_ptr()) }
    }
    
    #[inline]
    pub fn one_assign(&mut self) {
        unsafe { fmpq_poly_one(self.as_mut_ptr()) }
    }
    ...
    pub fn numerator(&self) -> IntPoly {
        ...
        unsafe {
            fmpq_poly_get_numerator(res.as_mut_ptr(), self.as_ptr());
        }
        res
    }
    ...
    pub fn denominator(&self) -> Integer {
        ...
        unsafe {
            fmpq_poly_get_denominator(res.as_mut_ptr(), self.as_ptr());
        }
        res
    }
    ...
    pub fn is_zero(&self) -> bool {
        unsafe { fmpq_poly_is_zero(self.as_ptr()) == 1}
    }

    #[inline]
    pub fn is_one(&self) -> bool {
        unsafe { fmpq_poly_is_one(self.as_ptr()) == 1}
    }

    #[inline]
    pub fn is_gen(&self) -> bool {
        unsafe { fmpq_poly_is_gen(self.as_ptr()) == 1}
    }
    
    #[inline]
    pub fn len(&self) -> usize {
        unsafe {
            let len = fmpq_poly_length(self.as_ptr()); 
    ...
    pub fn degree(&self) -> i64 {
        unsafe { fmpq_poly_degree(self.as_ptr()) }
    }
