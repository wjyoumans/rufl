...
impl Integer {
    /// Returns a pointer to the inner [FLINT integer][flint::fmpz].
    #[inline]
    ...
    /// Returns a mutable pointer to the inner [FLINT integer][flint::fmpz].
    #[inline]
    ...
    /// Create an Integer from an initialized [FLINT integer][flint::fmpz].
    ///
    /// # Safety
    ///
    ...
    ///   * The [`flint::fmpz`] type can be considered as a kind of pointer, so there
